        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              building modern, responsive websites and applications using React,
              JavaScript, and other cutting-edge technologies.
            </p>

            <p className="text-muted-foreground">
              I am passionate about creating seamless user experiences and
              continuously learning new skills to stay ahead in the tech
              industry.
            </p>
            ...
            <div className="gradient-border p-6 card-hover">
                <div className="flex items-start gap-4">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-muted-foreground">Leading projects from conception to completion with agile methodologies0.</p>
                    </div>
                </div>
            </div>
